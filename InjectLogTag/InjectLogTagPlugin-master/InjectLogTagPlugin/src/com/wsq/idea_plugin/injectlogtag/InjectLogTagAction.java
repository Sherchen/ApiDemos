...
public class InjectLogTagAction extends BaseGenerateAction {
    ...
    static class GenerateInjectLogHandler implements CodeInsightActionHandler {
        ...
        public void invoke(@NotNull Project project, @NotNull Editor editor, @NotNull PsiFile psiFile) {
            warning("Inject LOG_TAG", "Invoke is called.");
            Log.print("InjectLogTagAction invoke method is called", true);
            ...
            Log.print("InjectLogTagAction invoke method is called 1");
        ...
        private String generateLogTagCode(PsiClass psiClass) {
            ...
            sb.append("private static final String LOG_TAG = %s.class.getSimpleName();");
            sb.append("\n");
            sb.append("private static final boolean DEBUG = true;");
            sb.append("\n");
            sb.append("\t");
            sb.append("private void debug(String msg) {");
            sb.append("\n");
            sb.append("\t\t");
            sb.append("if(DEBUG) android.util.Log.v(LOG_TAG, msg);");
            sb.append("\n");
            sb.append("\t}");
            return String.format(sb.toString(), psiClass.getName());
